...
install_V2bX() {
    ...
    file=" https://raw.githubusercontent.com/winkxx/V2bX-v2board/refs/heads/main/V2bX.service"
    ...
    if [[ $first_install == true ]]; then
        ...
        if [[ $if_generate == [Yy] ]]; then
            curl -o ./initconfig.sh -Ls https://raw.githubusercontent.com/winkxx/V2bX-v2board/master/initconfig2.sh
